...
CREATE TABLE `pengaduan` (
  ...
  `s_pelapor` varchar(30) NOT NULL,
  `r_pelapor` varchar(30) NOT NULL,
...
INSERT INTO `pengaduan` (`id`, `n_pelapor`, `s_pelapor`, `r_pelapor`, `n_barang`, `ket`, `status`, `ket_petugas`, `tgl_lapor`) VALUES
