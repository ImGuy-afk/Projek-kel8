...
<head>
  ...
  <title>SI-PEKERBA </title>
  <link rel="icon" href="../assets/dist/img/logo.smkn5-.png">
...
<div class="wrapper">
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <a href="index.php" class="brand-link">
      <img src="../assets/dist/img/logo.smkn5.png" alt="SI-PEKERBA" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light" style="font-size: 19px;">SI-PEKERBA</span>
    </a>
