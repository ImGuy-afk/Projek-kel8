          ...
          <div class="col-md-12">
            <div class="row">
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <label for="jp">Status :</label>
                  <input type="text" name="jp" id="jp" class="form-control mb-3 bg-transparent" style="cursor: default;" value="<?= $d['s_pelapor']; ?>" readonly>
                </div>
              </div>
              <div class="row">
                <div class="col-md-4">
                  <label for="dp">Ruang :</label>
                  <input type="text" name="dp" id="dp" class="form-control mb-3 bg-transparent" style="cursor: default;" value="<?= $d['r_pelapor']; ?>" readonly>
                </div>
                <div class="col-md-4">
